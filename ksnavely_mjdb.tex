...
Achieving this low background goal requires a multifaceted strategy including shielding, assembly in an ultra-clean environment,
...
to red-flag parts which may be excessively radioactive, or aid in troubleshooting if a source of background
...
Google Maps Application Programming Interface (API) \cite{google_maps_dev_guide} to convert these addresses into latitutdes, longtitudes, and elevations,
...
with the models they represent. In this fashion the parts tracking database uses certain Collection objects 
as the controllers of the MVC pattern. In terms of design patterns, the Collection singletons 
