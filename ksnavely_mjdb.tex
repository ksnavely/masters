...
that information. PartForms has a method for getting or setting the material type -- grabbing the value from the
desired Form model.
...
functions are run. To modify DBRecord or HistoryRecord models (other than direct data entry) views pass messages to 
RecordCollection or HistoryCollection which cleaning prescribe linking interactions between models.
