...
experiment searching for the neutrinoless double beta decay process.
Detecting neutrinoless double beta decay requries extreme radiopurity of components
used in the experiment's construction.
The \textsc{Majorana} parts tracking database is a software effort with the goal of tracking
cosmogenic activation in materials and parts used by the collaboration.
Tracking the location of parts as they are produced provides an estimate
of their exposure to activating cosmic radiation. Access to part data also provides
...
\IEEEPARstart{D}{etecting} neutrinoless double beta decay (\znbb) would reveal whether the neutrinos are their own antiparticles,
...
converted into time and elevation profiles which can be used to limit
material activity.
...
with a common provenance in a bag and detailing the information on the bag.
...
rather is a document based database.
...
resource intensive tasks without no added development work.
