...
The Backbone View detects the model's change and refreshes the user interface.
View objects contain the logic and functions for interactions with the page content.
...
JQuery is a popular JavaScript library which simplifies interactions with the page content and also provides
