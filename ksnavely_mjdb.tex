...
There are many materials used in the \textsc{Demonstrator}, but the The bulk of the mass of the \textsc{Demonstrator}'s components is copper.
...
flow of stock material to finished parts is an important resposibility of the PTDB.
...
built in getter and setter functions.
...
for interactions with the Document Object Model (DOM), the objects which represent page content. 
...
choosen to use its HTTP functionality and return exposure data as JSON strings. By
