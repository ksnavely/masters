...
\IEEEPARstart{D}{etecting} \znbb\ would reveal whether the neutrinos are their own antiparticles,
...
Google Maps Application Programming Interfaces (APIs) to geocode these
...
rather is document based database, and services such as Cloudant wrap
distributed CouchDB instances together providing a cloud model for data storage. Database management
is minimized using Cloudant and developers can focus on creating client applications.
...
base Model, View, and Collection (rather than Controller -- there are many MVC variants) objects with APIs designed for use together. Some of the
API is borrowed from another toolkit known as Underscore.js. The Backbone Model 
