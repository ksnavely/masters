...
and a Python exposure calculator have been developed to be used as tools for
...
the mass hiearchy of the neutrino family (REF [http://iopscience.iop.org.libproxy.lib.unc.edu/1742-6596/375/4/042010/]).
...
which comprises REF [http://www.sciencedirect.com.libproxy.lib.unc.edu/science/article/pii/S0370157304003515] 26\% of the mass-energy density in the universe.
...
radiation originating from detector components. \textsc{Majorana} has developed a CouchDB  REF [http://guide.couchdb.org/] based 
...
Google Maps Application Programming Interfaces (APIs) REF [https://developers.google.com/maps/documentation/javascript/tutorial] to convert these addresses into latitutdes, longtitudes, and elevations,
...
queries. MapReduce is an approach which optimizes a given query for parallel/cluster computing. REF [http://dl.acm.org.libproxy.lib.unc.edu/citation.cfm?id=2094118] First a map function
...
documents change or are added to the database and results are cached, reducing view result build time REF [http://guide.couchdb.org/draft/views.html].
